    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20 sm:py-32">
        <div className="prose prose-stone max-w-none">
          <h1 className="text-4xl font-serif mb-8 text-[#2C2420]">Stawi AFRIKA</h1>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2 text-[#6B6560]">
              <li>“Stawi Afrika”, “we”, “us”, or “our” refers to the entity offering goods and/or services under this agreement;</li>
              <li>“Customer”, “you”, or “your” refers to the purchaser or participant in any of our products or events;</li>
              <li>“Products” refers to goods available for sale through Stawi Afrika;</li>
              <li>“Events” refers to organized experiences, sessions, or activities hosted or facilitated by Stawi Afrika.</li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#6B6560]">3.2. Stawi Afrika shall bear no responsibility for delivery delays, misdeliveries, or losses once goods have been dispatched.</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#6B6560]">4.3. Stawi Afrika accepts no liability for personal belongings lost, misplaced, or stolen during any Event.</p>
          </section>

          <section className="mb-12">
            <h3 className="text-xl font-serif font-bold text-[#2C2420] mb-4">5. THIRD-PARTY LIABILITY</h3>
            <p className="text-[#6B6560]">5.1. Vendors participating in Events, including but not limited to food providers, operate independently and are solely responsible for their products and services. Stawi Afrika disclaims liability for food allergies, food poisoning, or dissatisfaction with vendor services.</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#6B6560]">6.1. To the fullest extent permitted by law, Stawi Afrika shall not be liable for:</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#6B6560]">7.1. Stawi Afrika complies with the Data Protection Act of Kenya (2019) and any applicable data privacy laws. Personal data collected shall be used solely for internal administrative purposes and shall not be shared or sold without express consent.</p>
            <p className="text-[#6B6560]">7.2. By participating in our Events, you grant Stawi Afrika an irrevocable, worldwide, royalty-free license to capture, use, and disseminate your image in any media for promotional or commercial purposes, unless you provide written notice of objection at least seven (7) days prior to the Event date.</p>
          </section>

          <section className="mb-12">
            <h3 className="text-xl font-serif font-bold text-[#2C2420] mb-4">8. MISCELLANEOUS</h3>
            <p className="text-[#6B6560]">8.1. These Terms may be amended from time to time without prior notice. It is the responsibility of the Customer to review the most current version available at www.Stawiafrika.com/terms.</p>
            ...
            <ul className="list-none pl-0 space-y-2 text-[#6B6560]">
              <li>Email: info@Stawiafrika.com</li>
