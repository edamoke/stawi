    ...
    <footer className="bg-[#2C2420] text-white relative">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-white/60 text-sm leading-relaxed mb-6 max-w-xs">
              Premium Stawi cosmetics and beauty products. African excellence in natural skincare and beauty.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                { label: "All Products", href: "/our-collection" },
                { label: "Skincare", href: "/our-collection?category=skincare" },
                { label: "Haircare", href: "/our-collection?category=haircare" },
                { label: "Body Care", href: "/our-collection?category=body-care" },
                { label: "Scents", href: "/our-collection?category=scents" },
              ].map((item) => (
                <li key={item.label}>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                { label: "Usage Guide", href: "/care-guide" },
                { label: "FAQ", href: "/faq" },
              ].map((item) => (
                <li key={item.label}>
                  <Link href={item.href} className="text-sm text-white/70 hover:text-[#8B4513] transition-colors">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/40 text-center sm:text-left">© 2025 Stawi. All Rights Reserved.</p>
